...
export async function simulateDedust(chain, master, simulator, jettonWallet, buyAmount) {
    ...
    if ((await tonVault.getReadinessStatus()) !== ReadinessStatus.READY || (await jettonVault.getReadinessStatus() !== ReadinessStatus.READY))
        return null;

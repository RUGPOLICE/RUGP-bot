...
",
                ...
                'is_revoked_warning' => [
                    'yes' => "Нельзя добавить количество монет, изменить % или запретить продажу.\n",
                    'no' => "Можно добавить количество монет, изменить % или запретить продажу.

...
",
                ...
                'lp_burned' => [
                    ...
                    'scan' => "├🔎 <i>Проверяю сожжение LP</i>",
                    'unknown' => "├🤷‍♂️ <i>Не удалось проверить сожжение LP</i>",
                    'warning' => "
...
- Подробнее --> ♻️."
      ...
      <b>:value% на <a href=':link'>:type</a></b> :unlocks",
                    ...
                    'scan' => "\n└🔎 <i>Проверяю лок LP</i>",
                    'unknown' => "\n└🤷‍♂️ <i>Не удалось проверить лок LP</i>",
                    'burned' => "",
                    'unlocks' => "до :value",
                    'dyor' => "/ more locks! DYOR",
                ],
                'tax_buy' => [
                    'scan' => "├<i>🔎️ Проверяю налог на покупку</i>",
                ...
                'tax_sell' => [
                    'scan' => "├<i>🔎️ Проверяю налог на продажу</i>",
                    'unknown' => "└<i>🤷‍♂️ Проверка не удалась</i>",
                    'no' => "

...
<b>RUGP бот - Ваш верный помощник и защитник в криптомире!</b>
...
🔜
   ...
   <a href='http://rugp.io'>WEB</a>    |    <a href='t.me/rugp_ton'>Telegram</a>    |     <a href='https://x.com/rugp_ton'>Twitter</a>
...
Возможные причины: неверный адрес, удаленный скам или долгое время нет покупок и/или продаж.",
    ...
    'buttons' => [
        ...
        'warnings_hidden' => "⚠️ скрыть",
        'warnings_shown' => "⚠️ показать",
    ],
];
